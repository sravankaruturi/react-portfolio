...
const MENU_LIST = [
  ...
  {
    href: "/portfoliopage", text: "Portfolio"
  },
  {
    href: "https://gamedevlog.hashnode.dev", text: "Dev Blog"
  },
  {
...
function MobileNavLink({ to, elementText }) {
  return (
    <Link className="text-xl font-medium my-4" href={to} onClick={() => setTimeout(() => { setOpen(!open) }, 100)}>
      {elementText}
    </Link>
  )
}
